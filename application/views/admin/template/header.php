...
<!DOCTYPE html>
<html lang="en">
<head><title><?php echo ($title)? $title : SITE_NAME ?></title>
    <meta charset="utf-8">
                ...
                <ul class="nav navbar navbar-top-links navbar-right mbn">
                    ...
                    <li class="dropdown topbar-user"><a data-hover="dropdown" href="#" class="dropdown-toggle"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/kolage/48.jpg" alt="" class="img-responsive img-circle"/>&nbsp;<span class="hidden-xs">John Doe</span>&nbsp;<span class="caret"></span></a>
                        <ul class="dropdown-menu dropdown-user pull-right">
                            ...
                            <li><a href="<?php echo base_url('admin/logOutAdmin'); ?>"><i class="fa fa-key"></i>Log Out</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="user-panel">
                        ...
                        <div class="info"><p>John Doe</p>
                            <ul class="list-inline list-unstyled">
                                ...
                                <li><a href="<?php echo base_url('admin/logOutAdmin'); ?>" data-hover="tooltip" title="Logout"><i class="fa fa-sign-out"></i></a></li>
                            </ul>
                        </div>
